...
public class StreamState {
	...
	long[] granule_vals; // pcm_pos values for headers. Not compact this way,
							// but it is simple coupled to thelacing fifo
	int lacing_storage;
	int lacing_fill;
	int lacing_packet;
	int lacing_returned;
	...
	int b_o_s; // set after we've written the initial page of a logical
				// bitstream
	int serialno;
	int pageno;
	long packetno; /*
