...
class StaticCodeBook {
	...
	StaticCodeBook(int dim, int entries, int[] lengthlist, int maptype, int q_min, int q_delta, int q_quant,
			int q_sequencep, int[] quantlist, Object nearest_tree, Object thresh_tree) {
		this();
		this.dim = dim;
